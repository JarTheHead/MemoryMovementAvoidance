...
echo "Usage examples:"
echo ""
echo "# Basic workload (any system):"
echo "sudo cgexec -g memory:movement_avoidance_test python3 workload.py"
echo ""
echo "# NUMA-aware workload (bind to specific node):"
echo "sudo cgexec -g memory:movement_avoidance_test/node0 python3 workload.py"
echo ""
echo "# With stress-ng sweep:"
echo "python3 stressng_workload.py --duration 30 --pattern random --contention 50"
echo ""
echo "# With real workloads:"
echo "python3 real_workloads.py --workload redis --action sweep"
echo "python3 real_workloads.py --workload llama --action sweep --model /path/to/model"
echo ""
